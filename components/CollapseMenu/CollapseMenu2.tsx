...
export default function App() {
  const { isOpenCollapse2, setIsOpenCollapse,setIsOpenCollapse2,setIsOpenCollapse3,  setOpenDrawer }: any =
    useContext(StopPropagination);

  const handleToggle = () => setIsOpenCollapse2(!isOpenCollapse2);

  const menuStyles = {
    transform: isOpenCollapse2 ? "translateY(0%)" : "translateY(-20%)",
    transition: "all 0.5s ease-out",
    minHeight: isOpenCollapse2 ? "100px" : 0,
  };
